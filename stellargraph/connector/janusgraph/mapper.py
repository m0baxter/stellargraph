...
from .graph import JanusGraphStellarGraph
...
class JanusGraphBatchedNodeGenerator:
    """
    Abstract base class for graph data generators from JanusGraph.
    ...
    Args:
        graph (JanusGraphStellarGraph): The machine-learning ready graph.
    ...
    def __init__(self, graph, batch_size, schema=None):
        ...
        # FIXME: JanusGraphStellarGraph must support creating schema in order to extend this for HinSAGE
        self.schema = schema
...
@experimental(reason="the class is not fully tested")
class JanusGraphGraphSAGENodeGenerator(JanusGraphBatchedNodeGenerator):
    """
    A data generator for node prediction with Homogeneous GraphSAGE models

    At minimum, supply the JanusGraphStellarGraph, the batch size, and the number of
    node samples for each layer of the GraphSAGE model.

    The supplied graph should be a JanusGraphStellarGraph object with node features.
    ...
    .. seealso::
       ...
       Related functionality: :class:`.GraphSAGENodeGenerator` for using :class:`.GraphSAGE` without JanusGraph.

    Args:
        graph (JanusGraphStellarGraph): JanusGraphStellarGraph object
        batch_size (int): Size of batch to return.
    ...
    def __init__(self, graph, batch_size, num_samples, name=None):
        ...
        self.sampler = JanusGraphSampledBreadthFirstWalk(graph)

    def sample_features(self, head_nodes, batch_num):
        """
        Collect the features of the nodes sampled from JanusGraph,
...
@experimental(reason="the class is not fully tested")
class JanusGraphDirectedGraphSAGENodeGenerator(JanusGraphBatchedNodeGenerator):
    """
    A data generator for node prediction with homogeneous GraphSAGE models
    on directed graphs.
    ...
    .. seealso::
       ...
       Related functionality: :class:`.DirectedGraphSAGENodeGenerator` for using :class:`.DirectedGraphSAGE` without JanusGraph.

    Args:
        graph (JanusGraphStellarDiGraph): JanusGraphStellarGraph object
        batch_size (int): Size of batch to return.
    ...
    def __init__(
        ...
        self.sampler = JanusGraphDirectedBreadthFirstNeighbors(graph)

    def sample_features(self, head_nodes, batch_num):
        """
        Collect the features of the sampled nodes from JanusGraph,
...
@experimental(reason="the class is not fully tested")
class JanusGraphBatchedLinkGenerator:
    """
    Abstract base class for graph data generators from JanusGraph.
...
@experimental(reason="the class is not fully tested")
class JanusGraphGraphSAGELinkGenerator(JanusGraphBatchedLinkGenerator):
    """
...
@experimental(reason="the class is not fully tested")
class JanusGraphDirectedGraphSAGELinkGenerator(JanusGraphBatchedLinkGenerator):
    """
    A data generator for link prediction with homogeneous GraphSAGE models
    on directed graphs.
